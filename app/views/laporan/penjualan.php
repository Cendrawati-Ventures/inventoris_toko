        ...
        <table class="min-w-full table-fixed bg-white text-center">
            ...
            <thead class="bg-slate-100">
                <tr>
                    ...
                    <th class="px-3 py-3 text-sm font-semibold text-gray-700 align-middle whitespace-nowrap">Total</th>
                </tr>
            </thead>
                ...
                <?php else: ?>
                    <?php foreach ($penjualan as $index => $item): ?>
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-3 py-3 text-sm font-semibold text-emerald-700 align-middle whitespace-nowrap"><?= formatRupiah($item['harga_satuan']) ?></td>
                            <td class="px-3 py-3 text-sm font-bold text-blue-700 align-middle whitespace-nowrap"><?= formatRupiah($item['total_harga']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
