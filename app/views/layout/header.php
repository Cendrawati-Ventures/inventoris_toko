...
<body class="bg-gray-100 h-full flex flex-col">
        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-3">
                <!-- Logo & Brand -->
                    ...
                    <div class="bg-white bg-opacity-20 p-2 rounded-lg group-hover:bg-opacity-30 transition">
                        <i class="fas fa-store text-2xl"></i>
                    </div>
                    <div>
                        <h1 class="text-xl font-bold">UD. Bersaudara</h1>
                        <p class="text-xs text-blue-100">Sistem Inventori</p>
                    </div>
                </a>
    ...
    <footer class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white mt-12 shadow-2xl">
