...
function printNota() {
    ...
    let html = '<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Print Nota</title><style>@page{margin:1mm}body{font-family:"' + fontNota + '", monospace;width:' + width + 'mm;margin:0 auto;padding:2mm}.header{text-align:center;margin-bottom:6mm}.header h2{margin:0;font-size:15px}.header p{margin:2px 0;font-size:11px;color:#444}.header .muted{color:#777;font-size:10px}.header .custom{margin-top:4px;color:#333;font-size:10px;line-height:1.3}hr{margin:4px 0;border:none;border-top:1px solid #000}.info{font-size:11px;margin-bottom:5mm;line-height:1.4}table{width:100%;font-size:10px;border-collapse:collapse;margin-bottom:6mm}table thead tr{border-bottom:1px solid #000}table th{text-align:left;padding:3px 0;font-weight:bold}table td{padding:3px 0}table th:nth-child(2),table td:nth-child(2),table th:nth-child(3),table td:nth-child(3),table th:nth-child(4),table td:nth-child(4){text-align:right}table tbody tr{border-bottom:1px dotted #ccc}table .muted{color:#555;font-size:9px}.summary{font-size:11px;margin-bottom:5mm;line-height:1.5}.summary-row{display:flex;justify-content:space-between}.total-row{border-top:1px solid #000;padding-top:3px;font-weight:bold}.footer{text-align:center;font-size:10px;color:#444;margin-top:6mm;line-height:1.4}@media print{body{margin:0 auto;padding:2mm}}</style></head><body>';
